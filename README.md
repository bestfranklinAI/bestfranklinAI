...
🎓 **Year 5 Dual Degree Student** in **Technology and Management** (HKUST), majoring in **Computer Science** and **Finance**, with an extended major in **Artificial Intelligence**.  <br>💻 Passionate about **software development**, **data analysis**, and **machine learning**.  <br>🌐 Experienced in **full-stack development** and building scalable APIs.
